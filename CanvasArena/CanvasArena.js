...
testObj.playerBullet.frag = new Object();
testObj.playerBullet.frag.a = new Object();
testObj.playerBullet.frag.a.lifetime=100;
testObj.playerBullet.frag.a.IsAvalableTF = 1;
testObj.playerBullet.frag.a.speed = 0;
testObj.playerBullet.frag.a.xHsize = 64;
testObj.playerBullet.frag.a.yHsize = 84;
testObj.playerBullet.frag.a.xSize = 15;
testObj.playerBullet.frag.a.ySize = 7;
testObj.playerBullet.frag.a.xRadius=Math.floor(testObj.playerBullet.frag.a.xSize/2);
testObj.playerBullet.frag.a.yRadius=Math.floor(testObj.playerBullet.frag.a.ySize/2);
testObj.playerBullet.frag.a.yCord = 430;
testObj.playerBullet.frag.a.xCord = 650;
testObj.playerBullet.frag.a.centerXCord = testObj.playerBullet.frag.a.xCord+testObj.playerBullet.frag.a.xRadius;
testObj.playerBullet.frag.a.centerYCord = testObj.playerBullet.frag.a.yCord+testObj.playerBullet.frag.a.yRadius;
testObj.playerBullet.frag.a.theta = 270;
testObj.playerBullet.frag.a.htmlOut = 0;
testObj.playerBullet.frag.a.hClass="playerBulletHead";
testObj.playerBullet.frag.a.Class="playerBulletHtml";
testObj.playerBullet.frag.a.ID="testObjFrag_AHtml";
testObj.playerBullet.frag.a.htmlIn = '<div style="transform:rotate('+testObj.playerBullet.frag.a.theta+'deg);left:'+testObj.playerBullet.frag.a.xCord+'px;top:'+testObj.playerBullet.frag.a.yCord+'px;width:'+testObj.playerBullet.frag.a.xSize+'px;height:'+testObj.playerBullet.frag.a.ySize+'px;"; id="'+testObj.playerBullet.frag.a.ID+'" class="'+testObj.playerBullet.frag.a.Class+'"><div style="width:'+testObj.playerBullet.frag.a.xHsize+'px;height:'+testObj.playerBullet.c.yHsize+'px;top:'+testObj.playerBullet.frag.a.yRadius+'px;left:'+testObj.playerBullet.frag.a.xRadius+'px;" class="'+testObj.playerBullet.frag.a.hClass+'"></div></div>';
